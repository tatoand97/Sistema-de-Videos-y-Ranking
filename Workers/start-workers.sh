...
start_gossip_open_close() {
  ...
  require_env GOSSIP_MINIO_BUCKET_RAW
  require_env GOSSIP_MINIO_BUCKET_PROCESSED
  (
    ...
    exec env \
      ...
      MINIO_ACCESS_KEY="$MINIO_ACCESS_KEY" \
      MINIO_SECRET_KEY="$MINIO_SECRET_KEY" \
      MINIO_BUCKET_RAW="$GOSSIP_MINIO_BUCKET_RAW" \
      MINIO_BUCKET_PROCESSED="$GOSSIP_MINIO_BUCKET_PROCESSED" \
