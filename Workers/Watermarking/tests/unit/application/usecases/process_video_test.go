...
func TestWatermarkingUseCase_Execute_Success(t *testing.T) {
	mockVideoRepo := &MockVideoRepository{}
	mockStorageRepo := &MockStorageRepository{}
	mockProcessingService := &MockProcessingService{}
	mockNotificationService := &MockNotificationService{}
	...
	processedData := []byte("watermarked data")
...
func TestWatermarkingUseCase_Execute_VideoNotFound(t *testing.T) {
	mockVideoRepo := &MockVideoRepository{}
	mockStorageRepo := &MockStorageRepository{}
	mockProcessingService := &MockProcessingService{}
	mockNotificationService := &MockNotificationService{}
...
func TestWatermarkingUseCase_Execute_DownloadError(t *testing.T) {
	mockVideoRepo := &MockVideoRepository{}
	mockStorageRepo := &MockStorageRepository{}
	mockProcessingService := &MockProcessingService{}
	mockNotificationService := &MockNotificationService{}
...
func TestWatermarkingUseCase_Execute_ProcessingError(t *testing.T) {
	mockVideoRepo := &MockVideoRepository{}
	mockStorageRepo := &MockStorageRepository{}
	mockProcessingService := &MockProcessingService{}
	mockNotificationService := &MockNotificationService{}
	...
	mockVideoRepo.On("UpdateStatus", "123", domain.StatusProcessing).Return(nil)
	mockStorageRepo.On("Download", "raw", "test.mp4").Return(inputData, nil)
	mockProcessingService.On("TrimToMaxSeconds", inputData, 30).Return(nil, errors.New("watermarking failed"))
	mockVideoRepo.On("UpdateStatus", "123", domain.StatusFailed).Return(nil)
...
func TestWatermarkingUseCase_Execute_NotificationError(t *testing.T) {
	mockVideoRepo := &MockVideoRepository{}
	mockStorageRepo := &MockStorageRepository{}
	mockProcessingService := &MockProcessingService{}
	mockNotificationService := &MockNotificationService{}
	...
	mockStorageRepo.On("Upload", "processed", "test.mp4", processedData).Return(nil)
	mockVideoRepo.On("UpdateStatus", "123", domain.StatusCompleted).Return(nil)
	mockNotificationService.On("NotifyVideoProcessed", "123", "test.mp4", "processed/test.mp4").Return(errors.New("notification failed"))
	...
	// Should not return error even if notification fails (it only logs)
	assert.NoError(t, err)
	mockVideoRepo.AssertExpectations(t)
	mockStorageRepo.AssertExpectations(t)
	mockProcessingService.AssertExpectations(t)
